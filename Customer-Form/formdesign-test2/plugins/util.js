...
function onImgRender(e){
    ...
    var ary=mini.decode(img);

    var aryRtn=[];
    aryRtn.push("<ul class='image'>");
    for(var i=0;i<ary.length;i++){
    	var json=ary[i];
		var url="";
    	if(json.type && json.type=="url"){
    		url=json.url;
            ...
            url=__rootPath + "/sys/core/file/imageView.do?thumb=true&fileId=" + json.fileId;
		}
        aryRtn.push("<li><img src='"+url+"' style='width:200px;height:auto' /></li>");
	}
    aryRtn.push("</ul>");
