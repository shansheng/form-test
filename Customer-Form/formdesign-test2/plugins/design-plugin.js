             ...
             },
             {
               ...
               },
               {
              	 ...
              	 popWidth:1000
                  	 ...
                  	 name:'mini-formcustomtable',//新__yangxin;
                  	 text:'表单模板',
                  	 tag:'div'
                },
                {
...
function registerPlugin(index){
	UE.plugins[extPlugins[index].name] = function () {
		...
		me.addListener( 'mouseover', function( t, evt ) {
			...
			if (  mPlugins==thePlugins) {
				if(el.tagName.toLowerCase()==pluginTag || mPlugins=="mini-textbox"){
					var dataType=el.getAttribute("datatype");
					var htmlAry=[];
					if (pluginName != "mini-grid-div"){//此判断用于”模板二控件“
							/*if(window.designMode && window.designMode=="BO"){
