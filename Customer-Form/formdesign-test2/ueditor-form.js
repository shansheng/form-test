...
UE.registerUI('chineseup',function(editor,uiName){
    ...
    findChineseUp = function(editor){
    	...
    	var node=$(selectNode);
    	if(node.attr("class")){
			if(selectNode.tagName=="DIV" && node.attr("class").indexOf("divContainer")> -1 ){
				return 0;
			}
		}
		return -1;
...
UE.registerUI('customqueryui',function(editor,uiName){
    ...
    isAllowControl=function(plugins){
    	var allowPluggins=["mini-textbox","mini-user","mini-datepicker","mini-group","mini-dep","mini-buttonedit",'mini-combobox',"mini-radiobuttonlist","mini-checkboxlist"];
...
/*function templateTwo() {
	var html='<div class="gridSpan" plugin="mini-grid-div"><div class="gridHeader" ></div><div class="gridBox" ></div></div>';
	templateView.execCommand('insertHtml',html);
}*/
...
UE.registerUI('myframe',function(editor,uiName){
